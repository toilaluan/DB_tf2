...
if __name__ == '__main__':
    ...
    _, model = dbnet()
    model.load_weights('DifferentiableBinarization/pretrained/db_48_2.0216_2.5701.h5', by_name=True, skip_mismatch=True)
    for image_path in glob.glob(osp.join('/mnt/disk1/luantt/DB/datasets/aimenext/test_images', '*.jpg')):
